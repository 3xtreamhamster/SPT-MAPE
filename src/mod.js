...
class MAPE {
    ...
    SetSoftSlotProtectArea(itemDB, item, config, frontArea, backArea, logger) {
    ...
    SetPlateSlotProtectArea(itemDB, item, frontArea, backArea) {
    ...
    SetPlateProtectArea(itemDB, item, protectArea) {
